package com.mattressapp.controller.datastructure;
...
public class CustomQueue {
    ...
    private LinkedList<MattressModel> vivaList; // Internal storage for the queue.
     ...
     *
     * @return the first MattressModel in the queue, or null if the queue is
 empty.
     * @throws IllegalStateException if the queue is empty.
     */
    public MattressModel deQueue() {
        try {
     ...
     *
     * @param studentModel the MattressModel to be added to the queue.
     * @return the current size of the queue after the operation , or -1 if the
     * queue is full.
     */
    public int enQueue(MattressModel studentModel) {
        if (isFull()) {
